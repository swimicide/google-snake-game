...
function addSnake(move, direction) {
    // console.log('뱀 좌표', ...coord);
    ...
    if (direction === 'left') {
        const plusSnake = gameBoard.childNodes[y] ? gameBoard.childNodes[y].childNodes[0].childNodes[x + 1] : null;
        // console.log(plusSnake);

        plusSnake.classList.add('snake');
        ...
        const plusSnake = gameBoard.childNodes[y] ? gameBoard.childNodes[y - 1].childNodes[0].childNodes[x] : null;
        // console.log(plusSnake);

        plusSnake.classList.add('snake');
    } else if (direction === 'up') {

        const plusSnake = gameBoard.childNodes[y] ? gameBoard.childNodes[y + 1].childNodes[0].childNodes[x + 1] : null;
        // console.log(plusSnake);
        plusSnake.classList.add('snake');
    }
}
